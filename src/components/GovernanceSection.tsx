...
const roles: Role[] = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Sikrer fuld dataportabilitet — al data skal kunne flyttes til anden leverandør",
      "OS2-fællesskabet fungerer som steward på GitHub-repositoryet",
      "Hosting ved OS2 med hver kommune som tenant, hvor kommuner selv beslutter, hvor data opbevares",
      "Understøtter NIS2-compliance og planlægger cybersecurity-review af den samlede løsning",
      "Klar definition af kildekode og driftsgrundlag for kommende udviklingspartnere",
      "Driftsmodellen skal afklares i fællesskabet som del af governanceprocessen",
    ],

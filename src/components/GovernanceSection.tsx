...
const roles: Role[] = [
  {
    ...
    responsibilities: [
      ...
      "Sætter retning via governance-board — roadmap og prioritering",
      "Stiller kvalitetskrav til licens, dokumentation og bidrag",
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Godkender lokalt ift. IT-sikkerhedspolitik",
      "Vælger frit leverandør til installation, drift og support",
    ],
    accent: "border-os2-blue/30 bg-os2-blue/[0.03]",
    iconBg: "bg-os2-blue/10 text-os2-blue",
  },
  {
    ...
    responsibilities: [
      ...
      "Tilbyder kommercielle services — installation, drift, support og avancerede modeller",
      "Bygger software og algoritmer oven på kerneproduktet",
      "Deltager i test og certificering efter fælles kvalitetskrav",
    ],
  ...
  },
  {
    ...
    responsibilities: [
      "Drifter fælles infrastruktur (dataplatform, API-gateway) med hosting ved OS2",
      "Sikrer dataportabilitet — al data kan flyttes til anden leverandør",
      "Understøtter NIS2-compliance og planlægger cybersecurity-review",
      "Driftsmodellen afklares i fællesskabet som del af governanceprocessen",
    ],
